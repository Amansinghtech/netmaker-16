...
wget -q -O /root/mosquitto.conf https://raw.githubusercontent.com/Amansinghtech/netmaker-16/master/docker/mosquitto.conf

echo "setting docker-compose..."

mkdir -p /etc/netmaker

wget -q -O /root/docker-compose.yml https://raw.githubusercontent.com/Amansinghtech/netmaker-16/master/compose/docker-compose.yml
